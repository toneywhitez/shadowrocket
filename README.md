...
**IP**:
- meta_ips.list - IP-подсети Meta (закоменчено)
- telegram_ips.list - IP-подсети Telegram (закоменчено)
- discord_ips.list - IP-подсети голосовых серверов Discord
- cloudflare_ips.list - IP-подсети CloudFlare

**+Добавлены порты для разблокировки звонков в TG & WA & Google Meet**
- voice.list
